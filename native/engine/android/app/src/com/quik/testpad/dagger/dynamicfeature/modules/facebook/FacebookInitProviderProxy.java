...
/**
 * FacebookInitProviderProxy
 */
public class FacebookInitProviderProxy extends ContentProvider {
    private static final String TAG = FacebookInitProviderProxy.class.getSimpleName();
    private ContentProvider provider;
    private ContentProvider getRealProvider(){
        if(provider == null){
            FacebookLoginModule module = DFManager.getInstance().facebookLoginModule;
            if(module != null){
                provider = module.provideFacebookContentProvider();
            }
        }
        return provider;
    }
